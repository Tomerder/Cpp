...
template <typename T>
typename std::enable_if<!is_container<T>::value>::type print(
...
int main()
{
	...
	// TODO: currently, we print a string by printing each character in
	// the string. This is undesirable. Follow the lab instructions to 
	// filter out any printable type (that has an operator<<) from the
